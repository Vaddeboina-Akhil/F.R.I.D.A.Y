...
def listen():
    ...
    try:
        ...
        text = text.replace("melt", "mail")
        text = text.replace("mel", "mail")
        text = text.replace("cloud", "claude")
        text = text.replace("clod", "claude")
        text = text.replace("friday's", "friday")
        text = text.replace("sent", "send")
        text = text.replace("open up", "open")
        text = text.replace("whatsapp message", "whatsapp")
        text = text.replace("e mail", "email")
        text = text.replace("e-mail", "email")
        text = text.replace("you tube", "youtube")
        text = text.replace("good", "google")
